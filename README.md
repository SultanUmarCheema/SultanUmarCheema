<!-- HEADER BANNER -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0D1117,50:0e4d8a,100:00b4d8&height=200&section=header&text=Sultan%20Umar%20Cheema&fontSize=48&fontColor=ffffff&fontAlignY=38&desc=Cybersecurity%20Engineer%20%7C%20Cloud%20%7C%20AI-Powered%20Security&descAlignY=58&descSize=18&animation=fadeIn" />
...
<p align="center">
  ...
  &nbsp;
  <a href="mailto:sultan.umar.790@gmail.com">
    <img src="https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white" />
  </a>
  &nbsp;
  <a href="https://github.com/SultanUmarCheema">
...
```yaml
name        : Sultan Umar Cheema
location    : Islamabad, Pakistan
focus       : Cybersecurity + AI + Cloud
passion     : Building tools that actually protect systems
currently   : Sharpening offensive & defensive skills
learning    : Threat intelligence, malware analysis
goal_2026   : Ship production-ready security tools
```
...
| 🛡️ Defensive Engineering | IDS concepts, alert correlation, anomaly detection workflows |
...
| ☁️ Cloud Security | AWS-based secure deployments, IAM hardening, CI/CD security |
| 🔍 OSINT & Forensics | Open-source intelligence gathering, advanced digital forensics |
...
|:---|:---|:---|
| ☁️ AWS Certifications | Amazon Web Services | Dec 2025 |
| 🔐 [APIsec Certified Practitioner](https://www.credly.com/badges/93deb5ac-8a68-46d5-9691-f746d72218e2/public_url) | APIsec University | Jul 2025 |
| 🔍 OSINT Lab | Cybrary | Mar 2025 |
| 🛡️ Google Cybersecurity Specialization | Google | Mar 2025 |
| 🕵️ Beyond the Basics: Advanced Digital Forensics | Belkasoft | Jan 2025 |
| ⚔️ Ethical Hacking | Ignite — National Technology Fund | Oct 2023 |
...
> 🔧 Repositories are being finalized — full project links dropping soon.

| Project | Description |
|:---|:---|
| 🛡️ AI Threat Detection | AI-powered security monitoring and threat detection tooling |
| 🔐 API Security Lab | OWASP API Top 10 testing and defensive validation |
| 🧪 Automation Pipelines | Vulnerability triage and detection orchestration workflows |
| ☁️ Cloud Security Experiments | AWS architecture patterns for hardened deployments |
...
- [ ] 🚀 Ship 3+ production-ready open-source security tools
- [ ] 🧠 Complete a threat intelligence & malware analysis deep dive
- [ ] ☁️ Achieve AWS Security Specialty certification
- [ ] 📝 Publish public writeups for all completed labs and CTFs
- [ ] 🤝 Contribute to a major open-source security project

<!-- CONTRIBUTION GRAPH -->
## 📈 Contribution Graph

[![Sultan's Contribution Graph](https://github-readme-activity-graph.vercel.app/graph?username=SultanUmarCheema&theme=tokyo-night&hide_border=true&area=true&bg_color=0D1117&color=00b4d8&line=00b4d8&point=ffffff)](https://github.com/SultanUmarCheema)
